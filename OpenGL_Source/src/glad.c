...
PFNGLPIXELFovPROC glad_glPixelFov = NULL;
...
PFNGLPIXELFovXOESPROC glad_glPixelFovxOES = NULL;
...
PFNGLFRAMEFovSGIXPROC glad_glFrameFovSGIX = NULL;
...
static void load_GL_VERSION_1_0(GLADloadproc load) {
	...
	glad_glPixelFov = (PFNGLPIXELFovPROC)load("glPixelFov");
...
static void load_GL_OES_fixed_point(GLADloadproc load) {
	...
	glad_glPixelFovxOES = (PFNGLPIXELFovXOESPROC)load("glPixelFovxOES");
...
static void load_GL_SGIX_frameFov(GLADloadproc load) {
	if(!GLAD_GL_SGIX_frameFov) return;
	glad_glFrameFovSGIX = (PFNGLFRAMEFovSGIXPROC)load("glFrameFovSGIX");
}
...
static int find_extensionsGL(void) {
	...
	GLAD_GL_SGIX_frameFov = has_ext("GL_SGIX_frameFov");
