...
VkApplicationInfo* HelloTriangleApplication::ApplicationInfoGet() const
{
	...
	appInfo.pApplicationName = "babbys first vulkan";
...
void HelloTriangleApplication::createInstance()
{
	...
	if (vkCreateInstance(&createinfo, NULL, &instance) != VK_SUCCESS)
		throw std::runtime_error("Couldnt create an INSTANCE");
...
void HelloTriangleApplication::createGraphicsPipeline()
{
	...
	if (res != VK_SUCCESS) {
		throw std::runtime_error("failed to create graphics pipeline!" + res);
	}
